...
/** Community uses the MariaDB migration ledger, not Supabase schema_version. */
export function shouldCheckSupabaseSchema(isCommunityBackend: boolean): boolean {
  return !isCommunityBackend
}
